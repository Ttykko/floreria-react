...
## ⚠️ Estado del Proyecto (Entorno Sandbox / Portafolio)
Este desarrollo se encuentra actualmente configurado en **Modo Demo Local**. La aplicación está optimizada exclusivamente como una plantilla de alto rendimiento para el análisis de flujos de conversión y automatización de pedidos mediante la API de WhatsApp, operando de forma aislada sin conexiones a servidores de producción de terceros.
...
Este desarrollo fue creado bajo una Arquitectura Jamstack Estática para resolver la necesidad de digitalizar un catálogo local sin incurrir en costos de mantenimiento de servidores, bases de datos ni pasarelas de pago complejas.
